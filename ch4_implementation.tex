...
condition nécessaire pour que l'expérience de sensibilité au nombre de
partitions (chapitre~\ref{ch:evaluation}) reste interprétable : avec une graine
...
\begin{itemize}
  ...
  \item \textbf{Se traduit, avec un degré de liberté nouveau} : le
    ...
    Spark (§\ref{sec:spark-partitions-coeurs}), ce qui permet une expérience de
    sensibilité au nombre de partitions que le modèle de Flink ne permet pas.
